...
activities = {
    ...
    "Soccer Team": {
        "description": "Join teammates for practice and weekend matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "carla@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Build skills, teamwork, and compete in intramural games",
    ...
    "Debate Team": {
        "description": "Develop public speaking and argument skills through competitions",
